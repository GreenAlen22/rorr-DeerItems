...
local burstSprite = Resources.sprite_load("DeerItems", "particle/TwistedOpinionBurst", PATH.."assets/sprites/particle/Explosive.png", 5, 32, 32)
local sndLaunch   = Resources.sfx_load("DeerItems", "TwistedOpinion/launch", PATH.."assets/sounds/launch.ogg")
local sndImpact   = Resources.sfx_load("DeerItems", "TwistedOpinion/impact", PATH.."assets/sounds/boom.ogg")
