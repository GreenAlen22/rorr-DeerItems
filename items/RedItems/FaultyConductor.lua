-- DeerItems-LeackedCapacitor / «Аварийный сверхпроводник» / "Faulty Conductor"
...
local sprite      = Resources.sprite_load("DeerItems", "item/LeackedCapacitor", PATH.."assets/sprites/items/sRedItems/LeackedCapacitor.png", 1, 18, 18)
local buffSprite  = Resources.sprite_load("DeerItems", "buff/LeackedCapacitor", PATH.."assets/sprites/buffs/LeackedCapacitor.png", 1, 4, 8)
local pulseSprite = Resources.sprite_load("DeerItems", "particle/LeackedCapacitor", PATH.."assets/sprites/particle/LeackedCapacitor.png", 5, 10, 10)
local sound       = Resources.sfx_load("DeerItems", "LeackedCapacitor/pulse", PATH.."assets/sounds/LeackedCapacitor.ogg")
...
local item = Item.new("DeerItems", "LeackedCapacitor")
...
item:onPostStep(function(actor, stack)
    ...
    local data = actor:get_data("LeackedCapacitor", GUID)
