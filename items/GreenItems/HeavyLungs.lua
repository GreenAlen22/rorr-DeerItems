...
-- Дополнительно увеличивает максимальное HP и реген ВСЕХ дронов владельца на 10% (+5% за стак).
...
local DRONE_BUFF_BASE  = 0.05    -- база множителя дронов (см. формулу ниже)
local DRONE_BUFF_STACK = 0.05    -- прибавка множителя дронов за стак
...
-- Итоговый множитель к HP/регену дрона: 1 + 0.05 + 0.05*стак.
-- Стак 1 → x1.10 (+10%), стак 2 → x1.15 (+15%) и т.д.
