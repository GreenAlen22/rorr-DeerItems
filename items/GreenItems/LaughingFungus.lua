...
objMushroom:onCreate(function(self)
    ...
    -- Столкновения считает сервер. Если синхронизированный гриб будет сам считать
    -- гравитацию у клиента, между обновлениями projectile_sync он провалится сквозь карту.
